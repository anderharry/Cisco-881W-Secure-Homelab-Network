...
configure terminal
  ...
  1.-dot11 mbssid (sirve para habilitar la emisión de múltiples SSID)

  2.-dot11 ssid Red_Segura_IoT (configuración OCULTA de la Red IoT)
      vlan 1
      authentication open
  ...
  3.-dot11 ssid wi-fi_Invitados ( configuración VISIBLE de la Red Invitados)
      vlan 2
      authentication key-management wpa version 2
      wpa-psk ascii 0 "CONTRASEÑA"
      guest-mode 
  ...
  4.-interface Dot11Radio0 (configuración de la Antena Física)
  ...
  5.-interface Dot11Radio0.2 (configuración el puente y el aislamiento para invitados)
